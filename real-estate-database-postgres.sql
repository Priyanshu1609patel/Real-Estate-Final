-- PostgreSQL Database: real-estate-database
...
-- CREATE DATABASE "real-estate-database" WITH ENCODING 'UTF8';
...
CREATE TABLE financial_details (
    ...
    emi_example_tenure INTEGER DEFAULT NULL,
...
-- Create trigger for financial_details table
CREATE TRIGGER update_financial_details_updated_at BEFORE UPDATE ON financial_details
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- Set sequence to current max value
SELECT setval('financial_details_id_seq', (SELECT MAX(id) FROM financial_details));
...
CREATE TABLE investment_analysis (
    ...
    payback_period_years INTEGER DEFAULT NULL,
...
-- Create trigger for investment_analysis table
CREATE TRIGGER update_investment_analysis_updated_at BEFORE UPDATE ON investment_analysis
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- Set sequence to current max value
SELECT setval('investment_analysis_id_seq', (SELECT MAX(id) FROM investment_analysis));
...
-- Create trigger for legal_details table
CREATE TRIGGER update_legal_details_updated_at BEFORE UPDATE ON legal_details
FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
...
-- Set sequence to current max value
SELECT setval('legal_details_id_seq', (SELECT MAX(id) FROM legal_details));

-- --------------------------------------------------------

-- Create indexes for better performance (optional but recommended)
CREATE INDEX idx_amenities_category ON amenities(category);
CREATE INDEX idx_amenities_rarity ON amenities(rarity);
CREATE INDEX idx_challenges_category ON challenges(category);
CREATE INDEX idx_challenges_severity ON challenges(severity);
CREATE INDEX idx_developers_name ON developers(name);
CREATE INDEX idx_financial_details_property_id ON financial_details(property_id);
CREATE INDEX idx_investment_analysis_property_id ON investment_analysis(property_id);
CREATE INDEX idx_legal_details_property_id ON legal_details(property_id);

-- Add comments to tables for documentation
COMMENT ON TABLE amenities IS 'Stores property amenities with categories and rarity levels';
COMMENT ON TABLE challenges IS 'Stores property-related challenges and issues';
COMMENT ON TABLE developers IS 'Stores real estate developer information';
COMMENT ON TABLE financial_details IS 'Stores financial information for properties';
COMMENT ON TABLE investment_analysis IS 'Stores investment analysis data for properties';
COMMENT ON TABLE legal_details IS 'Stores legal compliance and documentation details';
...
CREATE TABLE market_analysis (
    ...
    inventory_months INTEGER DEFAULT NULL,
    similar_properties_count INTEGER DEFAULT NULL,
...
-- Create trigger for market_analysis table
...
-- Set sequence to current max value
SELECT setval('market_analysis_id_seq', (SELECT MAX(id) FROM market_analysis));
...
CREATE TABLE properties (
  ...
  property_type VARCHAR(50) NOT NULL,
    ...
    land_area_sqft BIGINT DEFAULT NULL,
    total_units INTEGER DEFAULT NULL,
    total_towers INTEGER DEFAULT NULL,
    floors_per_tower INTEGER DEFAULT NULL,
    open_area_percentage DECIMAL(5,2) DEFAULT NULL,
    clubhouse_area_sqft INTEGER DEFAULT NULL,
    clubhouse_factor INTEGER DEFAULT NULL,
    park_area_acres DECIMAL(10,2) DEFAULT NULL,
    unit_density_per_acre INTEGER DEFAULT NULL,
    closest_metro_distance_km DECIMAL(5,2) DEFAULT NULL,
    airport_distance_km DECIMAL(5,2) DEFAULT NULL,
    approach_road_width_meters INTEGER DEFAULT NULL,
    possession_date DATE DEFAULT NULL,
  rera_approved BOOLEAN DEFAULT FALSE,
    rera_registration_number VARCHAR(255) DEFAULT NULL,
    rera_approvals_count INTEGER DEFAULT NULL,
    total_rera_approvals INTEGER DEFAULT NULL,
    price_per_sqft DECIMAL(10,2) DEFAULT NULL,
    min_price DECIMAL(12,2) DEFAULT NULL,
    max_price DECIMAL(12,2) DEFAULT NULL,
    min_unit_size_sqft INTEGER DEFAULT NULL,
    max_unit_size_sqft INTEGER DEFAULT NULL,
  status VARCHAR(50) DEFAULT 'Under Construction',
    propsoch_id INTEGER DEFAULT NULL,
...
CREATE TABLE property_amenities (
  id SERIAL PRIMARY KEY,
    ...
    amenity_id INTEGER DEFAULT NULL,
...
(1, 1, 1, TRUE, 2500, 50, 'Club Luxuria - Main Clubhouse', '2025-07-15 07:17:30'),
(2, 1, 2, TRUE, 1800, 30, 'Club Luxuria - Ground Floor', '2025-07-15 07:17:30'),
(3, 1, 3, TRUE, 1200, 20, 'Open Area - Fitness Zone', '2025-07-15 07:17:30'),
(4, 1, 4, TRUE, 1500, 40, 'Park Area - Central Location', '2025-07-15 07:17:30'),
(5, 1, 5, TRUE, 200, 8, 'Club Luxuria - Wellness Center', '2025-07-15 07:17:30'),
(6, 1, 6, TRUE, 300, 10, 'Club Luxuria - Wellness Center', '2025-07-15 07:17:30'),
(7, 1, 7, TRUE, 800, 25, 'Club Luxuria - Second Floor', '2025-07-15 07:17:30'),
(8, 1, 8, TRUE, 1200, 60, 'Club Luxuria - Ground Floor', '2025-07-15 07:17:30'),
(9, 1, 9, TRUE, 400, 10, 'Club Luxuria - Beauty Center', '2025-07-15 07:17:30'),
(10, 1, 10, TRUE, 1000, 30, 'Residential Block - Ground Floor', '2025-07-15 07:17:30'),
(11, 1, 11, TRUE, 1500, 30, 'Club Luxuria - Pool Area', '2025-07-15 07:17:30'),
(12, 1, 12, TRUE, 2000, 100, 'Ground Floor - Retail Area', '2025-07-15 07:17:30'),
(13, 1, 13, TRUE, 500, 15, 'Ground Floor - Medical Center', '2025-07-15 07:17:30'),
(14, 1, 14, TRUE, 800, 20, 'Park Area - Designated Zone', '2025-07-15 07:17:30'),
(15, 1, 15, TRUE, 2000, 200, 'Open Area - Central Location', '2025-07-15 07:17:30'),
(16, 1, 16, TRUE, 1800, 50, 'Open Area - Perimeter Track', '2025-07-15 07:17:30'),
(17, 1, 17, TRUE, 500, 10, 'Sports Complex - Court 1', '2025-07-15 07:17:30'),
(18, 1, 18, TRUE, 400, 8, 'Sports Complex - Indoor Courts', '2025-07-15 07:17:30'),
(19, 1, 19, TRUE, 300, 20, 'Sports Complex - Practice Area', '2025-07-15 07:17:30'),
(20, 1, 20, TRUE, 8000, 40, 'Open Area - Sports Ground', '2025-07-15 07:17:30'),
(21, 1, 21, TRUE, 6000, 30, 'Open Area - Sports Ground', '2025-07-15 07:17:30'),
(22, 1, 22, TRUE, 200, 4, 'Sports Complex - Court 2', '2025-07-15 07:17:30'),
(23, 1, 23, TRUE, 1000, 30, 'Sports Complex - Skating Area', '2025-07-15 07:17:30'),
(24, 1, 24, TRUE, 800, 8, 'Sports Complex - Tennis Courts', '2025-07-15 07:17:30'),
(25, 1, 25, TRUE, 400, 12, 'Sports Complex - Volleyball Court', '2025-07-15 07:17:30'),
(26, 1, 26, TRUE, 68000, 500, 'Central Park and Garden Areas', '2025-07-15 07:17:30'),
(27, 1, 27, TRUE, 20000, 100, 'Adjacent Natural Lake', '2025-07-15 07:17:30'),
(28, 1, 28, TRUE, 50000, 200, 'Nearby Forest Area', '2025-07-15 07:17:30'),
(29, 1, 29, TRUE, 100000, 0, 'Adjacent Army Land', '2025-07-15 07:17:30'),
(30, 1, 30, FALSE, 0, 0, 'Not Available', '2025-07-15 07:17:30'),
(31, 1, 31, FALSE, 0, 0, 'Not Available', '2025-07-15 07:17:30'),
(32, 2, 1, TRUE, 1500, 30, 'Main Clubhouse', '2025-07-15 07:17:30'),
(33, 2, 2, TRUE, 1200, 25, 'Clubhouse - Ground Floor', '2025-07-15 07:17:30'),
(34, 2, 4, TRUE, 1000, 30, 'Central Garden Area', '2025-07-15 07:17:30'),
(35, 2, 16, TRUE, 1200, 40, 'Perimeter Track', '2025-07-15 07:17:30'),
(36, 2, 17, TRUE, 400, 8, 'Sports Area', '2025-07-15 07:17:30'),
(37, 2, 26, TRUE, 25000, 200, 'Landscaped Gardens', '2025-07-15 07:17:30'),
(38, 3, 1, TRUE, 1200, 25, 'Community Clubhouse', '2025-07-15 07:17:30'),
(39, 3, 2, TRUE, 800, 20, 'Clubhouse - Fitness Center', '2025-07-15 07:17:30'),
(40, 3, 4, TRUE, 800, 25, 'Childrens Play Area', '2025-07-15 07:17:30'),
(41, 3, 16, TRUE, 800, 30, 'Jogging Track', '2025-07-15 07:17:30'),
(42, 3, 26, TRUE, 13000, 150, 'Park and Garden Areas', '2025-07-15 07:17:30'),
(43, 1, 1, TRUE, 2500, 50, 'Club Luxuria - Main Clubhouse', '2025-07-15 07:17:58'),
(44, 1, 2, TRUE, 1800, 30, 'Club Luxuria - Ground Floor', '2025-07-15 07:17:58'),
(45, 1, 3, TRUE, 1200, 20, 'Open Area - Fitness Zone', '2025-07-15 07:17:58'),
(46, 1, 4, TRUE, 1500, 40, 'Park Area - Central Location', '2025-07-15 07:17:58'),
(47, 1, 5, TRUE, 200, 8, 'Club Luxuria - Wellness Center', '2025-07-15 07:17:58'),
(48, 1, 6, TRUE, 300, 10, 'Club Luxuria - Wellness Center', '2025-07-15 07:17:58'),
(49, 1, 7, TRUE, 800, 25, 'Club Luxuria - Second Floor', '2025-07-15 07:17:58'),
(50, 1, 8, TRUE, 1200, 60, 'Club Luxuria - Ground Floor', '2025-07-15 07:17:58'),
(51, 1, 9, TRUE, 400, 10, 'Club Luxuria - Beauty Center', '2025-07-15 07:17:58'),
(52, 1, 10, TRUE, 1000, 30, 'Residential Block - Ground Floor', '2025-07-15 07:17:58'),
(53, 1, 11, TRUE, 1500, 30, 'Club Luxuria - Pool Area', '2025-07-15 07:17:58'),
(54, 1, 12, TRUE, 2000, 100, 'Ground Floor - Retail Area', '2025-07-15 07:17:58'),
(55, 1, 13, TRUE, 500, 15, 'Ground Floor - Medical Center', '2025-07-15 07:17:58'),
(56, 1, 14, TRUE, 800, 20, 'Park Area - Designated Zone', '2025-07-15 07:17:58'),
(57, 1, 15, TRUE, 2000, 200, 'Open Area - Central Location', '2025-07-15 07:17:58'),
(58, 1, 16, TRUE, 1800, 50, 'Open Area - Perimeter Track', '2025-07-15 07:17:58'),
(59, 1, 17, TRUE, 500, 10, 'Sports Complex - Court 1', '2025-07-15 07:17:58'),
(60, 1, 18, TRUE, 400, 8, 'Sports Complex - Indoor Courts', '2025-07-15 07:17:58'),
(61, 1, 19, TRUE, 300, 20, 'Sports Complex - Practice Area', '2025-07-15 07:17:58'),
(62, 1, 20, TRUE, 8000, 40, 'Open Area - Sports Ground', '2025-07-15 07:17:58'),
(63, 1, 21, TRUE, 6000, 30, 'Open Area - Sports Ground', '2025-07-15 07:17:58'),
(64, 1, 22, TRUE, 200, 4, 'Sports Complex - Court 2', '2025-07-15 07:17:58'),
(65, 1, 23, TRUE, 1000, 30, 'Sports Complex - Skating Area', '2025-07-15 07:17:58'),
(66, 1, 24, TRUE, 800, 8, 'Sports Complex - Tennis Courts', '2025-07-15 07:17:58'),
(67, 1, 25, TRUE, 400, 12, 'Sports Complex - Volleyball Court', '2025-07-15 07:17:58'),
(68, 1, 26, TRUE, 68000, 500, 'Central Park and Garden Areas', '2025-07-15 07:17:58'),
(69, 1, 27, TRUE, 20000, 100, 'Adjacent Natural Lake', '2025-07-15 07:17:58'),
(70, 1, 28, TRUE, 50000, 200, 'Nearby Forest Area', '2025-07-15 07:17:58'),
(71, 1, 29, TRUE, 100000, 0, 'Adjacent Army Land', '2025-07-15 07:17:58'),
(72, 1, 30, FALSE, 0, 0, 'Not Available', '2025-07-15 07:17:58'),
(73, 1, 31, FALSE, 0, 0, 'Not Available', '2025-07-15 07:17:58'),
(74, 2, 1, TRUE, 1500, 30, 'Main Clubhouse', '2025-07-15 07:17:58'),
(75, 2, 2, TRUE, 1200, 25, 'Clubhouse - Ground Floor', '2025-07-15 07:17:58'),
(76, 2, 4, TRUE, 1000, 30, 'Central Garden Area', '2025-07-15 07:17:58'),
(77, 2, 16, TRUE, 1200, 40, 'Perimeter Track', '2025-07-15 07:17:58'),
(78, 2, 17, TRUE, 400, 8, 'Sports Area', '2025-07-15 07:17:58'),
(79, 2, 26, TRUE, 25000, 200, 'Landscaped Gardens', '2025-07-15 07:17:58'),
(80, 3, 1, TRUE, 1200, 25, 'Community Clubhouse', '2025-07-15 07:17:58'),
(81, 3, 2, TRUE, 800, 20, 'Clubhouse - Fitness Center', '2025-07-15 07:17:58'),
(82, 3, 4, TRUE, 800, 25, 'Childrens Play Area', '2025-07-15 07:17:58'),
(83, 3, 16, TRUE, 800, 30, 'Jogging Track', '2025-07-15 07:17:58'),
(84, 3, 26, TRUE, 13000, 150, 'Park and Garden Areas', '2025-07-15 07:17:58');

-- Set sequence to current max value
SELECT setval('property_amenities_id_seq', (SELECT MAX(id) FROM property_amenities));
...
-- PostgreSQL version of the database schema and data
...
-- Insert data into property_documents
INSERT INTO property_documents (id, property_id, document_type, document_name, document_url, upload_date, created_at) VALUES
(1, 1, 'brochure', 'Prestige Lakeside Habitat - Project Brochure', 'https://www.propsoch.com/_next/image?url=https%3A%2F%2Fd1zk2x7mtoyb2b.cloudfront.net%2FProjectImages%2F274-lodha-mirabelle-thanisandra-road%2Fviews-2.png&w=3840&q=75', NULL, '2024-01-15 05:00:00'),
(2, 1, 'floor_plan', 'Prestige Lakeside - 2BHK Floor Plan', 'https://www.propsoch.com/_next/image?url=https%3A%2F%2Fd1zk2x7mtoyb2b.cloudfront.net%2FProjectImages%2F274-lodha-mirabelle-thanisandra-road%2Fviews-2.png&w=3840&q=75', NULL, '2024-01-15 05:30:00'),
...
SELECT setval('property_documents_id_seq', (SELECT MAX(id) FROM property_documents));
...
-- Insert data into property_gallery
...
(1, 1, 'Rajesh Kumar', 4.50, 'Excellent project with world-class amenities. The location is perfect for IT professionals working in Manyata Tech Park.', 'Premium amenities, Good location, Quality construction, Branded developer', 'High pricing, Traffic during peak hours', 'Recommended for premium buyers', 'Purchased - 3BHK', '2024-03-15', FALSE, 0, '2025-07-15 07:34:50', '2025-07-15 07:34:50'),
(2, 1, 'Priya Sharma', 4.00, 'Good project but the pricing is on the higher side. The amenities are impressive and the build quality is excellent.', 'Excellent amenities, Quality construction, Good connectivity', 'High cost, Limited parking', 'Good for investors', 'Considering purchase', '2024-02-20', FALSE, 0, '2025-07-15 07:34:50', '2025-07-15 07:34:50'),
(3, 1, 'Amit Patel', 4.20, 'Living here for 6 months now. The clubhouse facilities are amazing and the society is well-maintained.', 'World-class amenities, Good maintenance, Peaceful environment', 'High maintenance charges, Dense construction', 'Recommended for families', 'Purchased - 4BHK', '2024-01-10', FALSE, 0, '2025-07-15 07:34:50', '2025-07-15 07:34:50'),
(4, 2, 'Venkatesh Reddy', 3.80, 'Decent project with good amenities. The location is developing well and has good potential for appreciation.', 'Good amenities, Reasonable pricing, Growing location', 'Construction delays, Limited public transport', 'Good for long-term investment', 'Purchased - 3BHK', '2024-04-05', FALSE, 0, '2025-07-15 07:34:50', '2025-07-15 07:34:50'),
(5, 2, 'Sneha Iyer', 3.50, 'The project is good but there are some delays in construction. The amenities are as promised.', 'Good amenities, Reasonable pricing, Quality construction', 'Construction delays, Traffic issues', 'Wait for completion', 'Booked - 2BHK', '2024-03-28', FALSE, 0, '2025-07-15 07:34:50', '2025-07-15 07:34:50'),
(6, 3, 'Manoj Singh', 4.10, 'Great value for money project. Perfect for first-time buyers. The location is improving with good connectivity.', 'Affordable pricing, Good connectivity, Transparent dealing', 'Limited amenities, Basic finishing', 'Recommended for first-time buyers', 'Purchased - 2BHK', '2024-05-12', FALSE, 0, '2025-07-15 07:34:50', '2025-07-15 07:34:50'),
(7, 3, 'Kavitha Nair', 3.90, 'Good project for the price range. The builder has delivered as promised. Happy with the purchase decision.', 'Value for money, Good connectivity, Timely delivery', 'Limited amenities, Basic interiors', 'Good for budget-conscious buyers', 'Purchased - 3BHK', '2024-04-18', FALSE, 0, '2025-07-15 07:34:50', '2025-07-15 07:34:50'),
(8, 1, 'Rajesh Kumar', 4.50, 'Excellent project with world-class amenities. The location is perfect for IT professionals working in Manyata Tech Park.', 'Premium amenities, Good location, Quality construction, Branded developer', 'High pricing, Traffic during peak hours', 'Recommended for premium buyers', 'Purchased - 3BHK', '2024-03-15', FALSE, 0, '2025-07-15 07:35:19', '2025-07-15 07:35:19'),
(9, 1, 'Priya Sharma', 4.00, 'Good project but the pricing is on the higher side. The amenities are impressive and the build quality is excellent.', 'Excellent amenities, Quality construction, Good connectivity', 'High cost, Limited parking', 'Good for investors', 'Considering purchase', '2024-02-20', FALSE, 0, '2025-07-15 07:35:19', '2025-07-15 07:35:19'),
(10, 1, 'Amit Patel', 4.20, 'Living here for 6 months now. The clubhouse facilities are amazing and the society is well-maintained.', 'World-class amenities, Good maintenance, Peaceful environment', 'High maintenance charges, Dense construction', 'Recommended for families', 'Purchased - 4BHK', '2024-01-10', FALSE, 0, '2025-07-15 07:35:19', '2025-07-15 07:35:19'),
(11, 2, 'Venkatesh Reddy', 3.80, 'Decent project with good amenities. The location is developing well and has good potential for appreciation.', 'Good amenities, Reasonable pricing, Growing location', 'Construction delays, Limited public transport', 'Good for long-term investment', 'Purchased - 3BHK', '2024-04-05', FALSE, 0, '2025-07-15 07:35:19', '2025-07-15 07:35:19'),
(12, 2, 'Sneha Iyer', 3.50, 'The project is good but there are some delays in construction. The amenities are as promised.', 'Good amenities, Reasonable pricing, Quality construction', 'Construction delays, Traffic issues', 'Wait for completion', 'Booked - 2BHK', '2024-03-28', FALSE, 0, '2025-07-15 07:35:19', '2025-07-15 07:35:19'),
(13, 3, 'Manoj Singh', 4.10, 'Great value for money project. Perfect for first-time buyers. The location is improving with good connectivity.', 'Affordable pricing, Good connectivity, Transparent dealing', 'Limited amenities, Basic finishing', 'Recommended for first-time buyers', 'Purchased - 2BHK', '2024-05-12', FALSE, 0, '2025-07-15 07:35:19', '2025-07-15 07:35:19'),
(14, 3, 'Kavitha Nair', 3.90, 'Good project for the price range. The builder has delivered as promised. Happy with the purchase decision.', 'Value for money, Good connectivity, Timely delivery', 'Limited amenities, Basic interiors', 'Good for budget-conscious buyers', 'Purchased - 3BHK', '2024-04-18', FALSE, 0, '2025-07-15 07:35:19', '2025-07-15 07:35:19'),
(15, 1, 'Rajesh Kumar', 4.50, 'Excellent project with world-class amenities. The location is perfect for IT professionals working in Manyata Tech Park.', 'Premium amenities, Good location, Quality construction, Branded developer', 'High pricing, Traffic during peak hours', 'Recommended for premium buyers', 'Purchased - 3BHK', '2024-03-15', FALSE, 0, '2025-07-15 07:35:37', '2025-07-15 07:35:37'),
(16, 1, 'Priya Sharma', 4.00, 'Good project but the pricing is on the higher side. The amenities are impressive and the build quality is excellent.', 'Excellent amenities, Quality construction, Good connectivity', 'High cost, Limited parking', 'Good for investors', 'Considering purchase', '2024-02-20', FALSE, 0, '2025-07-15 07:35:37', '2025-07-15 07:35:37'),
(17, 1, 'Amit Patel', 4.20, 'Living here for 6 months now. The clubhouse facilities are amazing and the society is well-maintained.', 'World-class amenities, Good maintenance, Peaceful environment', 'High maintenance charges, Dense construction', 'Recommended for families', 'Purchased - 4BHK', '2024-01-10', FALSE, 0, '2025-07-15 07:35:37', '2025-07-15 07:35:37'),
(18, 2, 'Venkatesh Reddy', 3.80, 'Decent project with good amenities. The location is developing well and has good potential for appreciation.', 'Good amenities, Reasonable pricing, Growing location', 'Construction delays, Limited public transport', 'Good for long-term investment', 'Purchased - 3BHK', '2024-04-05', FALSE, 0, '2025-07-15 07:35:37', '2025-07-15 07:35:37'),
(19, 2, 'Sneha Iyer', 3.50, 'The project is good but there are some delays in construction. The amenities are as promised.', 'Good amenities, Reasonable pricing, Quality construction', 'Construction delays, Traffic issues', 'Wait for completion', 'Booked - 2BHK', '2024-03-28', FALSE, 0, '2025-07-15 07:35:37', '2025-07-15 07:35:37'),
(20, 3, 'Manoj Singh', 4.10, 'Great value for money project. Perfect for first-time buyers. The location is improving with good connectivity.', 'Affordable pricing, Good connectivity, Transparent dealing', 'Limited amenities, Basic finishing', 'Recommended for first-time buyers', 'Purchased - 2BHK', '2024-05-12', FALSE, 0, '2025-07-15 07:35:37', '2025-07-15 07:35:37'),
(21, 3, 'Kavitha Nair', 3.90, 'Good project for the price range. The builder has delivered as promised. Happy with the purchase decision.', 'Value for money, Good connectivity, Timely delivery', 'Limited amenities, Basic interiors', 'Good for budget-conscious buyers', 'Purchased - 3BHK', '2024-04-18', FALSE, 0, '2025-07-15 07:35:37', '2025-07-15 07:35:37');
...
-- Table structure for unit_specifications

CREATE TABLE unit_specifications (
  id serial PRIMARY KEY,
  unit_type_id integer DEFAULT NULL,
  efficiency_percentage numeric(5,2) DEFAULT NULL,
  most_misused_bedrooms text DEFAULT NULL,
  balcony_area_ratio numeric(5,2) DEFAULT NULL,
  common_walls_count integer DEFAULT NULL,
  common_walls_percentage numeric(5,2) DEFAULT NULL,
  floor_height_meters numeric(4,2) DEFAULT NULL,
  carpet_area_average_price numeric(10,2) DEFAULT NULL,
  elevator_count integer DEFAULT NULL,
...
-- Insert data into unit_specifications
...
(1, 1, 62.70, 'None - well-planned layout', 12.15, 2, 40.00, 3.05, 23339.00, 4, '1:275', '2.5BHK', true, 'Excellent', 'Excellent', '2025-07-15 07:17:30'),
(2, 2, 62.70, 'Third bedroom can be small', 13.05, 3, 50.00, 3.05, 23355.00, 4, '1:275', '3BHK', true, 'Excellent', 'Excellent', '2025-07-15 07:17:30'),
(3, 3, 64.30, 'Study room might be misused as bedroom', 13.33, 3, 42.90, 3.05, 22764.00, 4, '1:275', '3.5BHK', true, 'Excellent', 'Excellent', '2025-07-15 07:17:30'),
...
CREATE TABLE unit_types (
    ...
    carpet_area_percentage NUMERIC(5,2),
...
(id, property_id, bhk_type, configuration_name, area_sqft, price, carpet_area_sqft, carpet_area_percentage, balcony_area_sqft, ceiling_height_meters, bedrooms, bathrooms, unit_count, floor_count, price_per_sqft, configuration_details, created_at) VALUES
...
-- In Postgres, use a trigger to auto-update updated_at if you want MySQL-like ON UPDATE
CREATE OR REPLACE FUNCTION update_updated_at_column()
RETURNS TRIGGER AS $$
BEGIN
   NEW.updated_at = NOW();
...
ALTER TABLE financial_details ADD PRIMARY KEY (id);
ALTER TABLE financial_details ADD INDEX (property_id);
ALTER TABLE investment_analysis ADD PRIMARY KEY (id);
ALTER TABLE investment_analysis ADD INDEX (property_id);
ALTER TABLE legal_details ADD PRIMARY KEY (id);
ALTER TABLE legal_details ADD INDEX (property_id);
ALTER TABLE locations ADD PRIMARY KEY (id);
ALTER TABLE market_analysis ADD PRIMARY KEY (id);
ALTER TABLE market_analysis ADD INDEX (property_id);
ALTER TABLE properties ADD PRIMARY KEY (id);
ALTER TABLE properties ADD UNIQUE (propsoch_id);
ALTER TABLE properties ADD INDEX (developer_id);
ALTER TABLE properties ADD INDEX (location_id);
ALTER TABLE property_amenities ADD PRIMARY KEY (id);
ALTER TABLE property_amenities ADD INDEX (property_id);
ALTER TABLE property_amenities ADD INDEX (amenity_id);
ALTER TABLE property_challenges ADD PRIMARY KEY (id);
ALTER TABLE property_challenges ADD INDEX (property_id);
ALTER TABLE property_challenges ADD INDEX (challenge_id);
ALTER TABLE property_connectivity ADD PRIMARY KEY (id);
ALTER TABLE property_connectivity ADD INDEX (property_id);
ALTER TABLE property_documents ADD PRIMARY KEY (id);
ALTER TABLE property_documents ADD INDEX (property_id);
ALTER TABLE property_gallery ADD PRIMARY KEY (id);
ALTER TABLE property_gallery ADD INDEX (property_id);
ALTER TABLE reviews ADD PRIMARY KEY (id);
ALTER TABLE reviews ADD INDEX (property_id);
ALTER TABLE room_details ADD PRIMARY KEY (id);
ALTER TABLE room_details ADD INDEX (unit_type_id);
ALTER TABLE timeline ADD PRIMARY KEY (id);
ALTER TABLE timeline ADD INDEX (property_id);
ALTER TABLE unit_specifications ADD PRIMARY KEY (id);
ALTER TABLE unit_specifications ADD INDEX (unit_type_id);
ALTER TABLE unit_types ADD PRIMARY KEY (id);
ALTER TABLE unit_types ADD INDEX (property_id);
...
-- In PostgreSQL, AUTO_INCREMENT is handled by SERIAL during CREATE TABLE
-- No need for ALTER TABLE ... MODIFY

-- Example: if tables were created without SERIAL, you can attach sequences
-- (only needed if you already created with INT instead of SERIAL)
DO $$
DECLARE
    seq_name text;
BEGIN
    -- amenities
    IF NOT EXISTS (SELECT 1 FROM pg_class WHERE relname = 'amenities_id_seq') THEN
        CREATE SEQUENCE amenities_id_seq START 64;
        ALTER TABLE amenities ALTER COLUMN id SET DEFAULT nextval('amenities_id_seq');
    END IF;

    -- challenges
    IF NOT EXISTS (SELECT 1 FROM pg_class WHERE relname = 'challenges_id_seq') THEN
        CREATE SEQUENCE challenges_id_seq START 17;
        ALTER TABLE challenges ALTER COLUMN id SET DEFAULT nextval('challenges_id_seq');
    END IF;

    -- developers
    IF NOT EXISTS (SELECT 1 FROM pg_class WHERE relname = 'developers_id_seq') THEN
        CREATE SEQUENCE developers_id_seq START 7;
        ALTER TABLE developers ALTER COLUMN id SET DEFAULT nextval('developers_id_seq');
    END IF;

    -- financial_details
    CREATE SEQUENCE IF NOT EXISTS financial_details_id_seq START 10;
    ALTER TABLE financial_details ALTER COLUMN id SET DEFAULT nextval('financial_details_id_seq');

    -- investment_analysis
    CREATE SEQUENCE IF NOT EXISTS investment_analysis_id_seq START 10;
    ALTER TABLE investment_analysis ALTER COLUMN id SET DEFAULT nextval('investment_analysis_id_seq');

    -- legal_details
    CREATE SEQUENCE IF NOT EXISTS legal_details_id_seq START 10;
    ALTER TABLE legal_details ALTER COLUMN id SET DEFAULT nextval('legal_details_id_seq');

    -- locations
    CREATE SEQUENCE IF NOT EXISTS locations_id_seq START 5;
    ALTER TABLE locations ALTER COLUMN id SET DEFAULT nextval('locations_id_seq');

    -- market_analysis
    CREATE SEQUENCE IF NOT EXISTS market_analysis_id_seq START 10;
    ALTER TABLE market_analysis ALTER COLUMN id SET DEFAULT nextval('market_analysis_id_seq');

    -- properties
    CREATE SEQUENCE IF NOT EXISTS properties_id_seq START 5;
    ALTER TABLE properties ALTER COLUMN id SET DEFAULT nextval('properties_id_seq');

    -- property_amenities
    CREATE SEQUENCE IF NOT EXISTS property_amenities_id_seq START 85;
    ALTER TABLE property_amenities ALTER COLUMN id SET DEFAULT nextval('property_amenities_id_seq');

    -- property_challenges
    CREATE SEQUENCE IF NOT EXISTS property_challenges_id_seq START 15;
    ALTER TABLE property_challenges ALTER COLUMN id SET DEFAULT nextval('property_challenges_id_seq');

    -- property_connectivity
    CREATE SEQUENCE IF NOT EXISTS property_connectivity_id_seq START 91;
    ALTER TABLE property_connectivity ALTER COLUMN id SET DEFAULT nextval('property_connectivity_id_seq');

    -- property_documents
    CREATE SEQUENCE IF NOT EXISTS property_documents_id_seq START 30;
    ALTER TABLE property_documents ALTER COLUMN id SET DEFAULT nextval('property_documents_id_seq');

    -- property_gallery
    CREATE SEQUENCE IF NOT EXISTS property_gallery_id_seq START 37;
    ALTER TABLE property_gallery ALTER COLUMN id SET DEFAULT nextval('property_gallery_id_seq');

    -- reviews
    CREATE SEQUENCE IF NOT EXISTS reviews_id_seq START 22;
    ALTER TABLE reviews ALTER COLUMN id SET DEFAULT nextval('reviews_id_seq');

    -- room_details
    CREATE SEQUENCE IF NOT EXISTS room_details_id_seq START 171;
    ALTER TABLE room_details ALTER COLUMN id SET DEFAULT nextval('room_details_id_seq');

    -- timeline
    CREATE SEQUENCE IF NOT EXISTS timeline_id_seq START 46;
    ALTER TABLE timeline ALTER COLUMN id SET DEFAULT nextval('timeline_id_seq');

    -- unit_specifications
    CREATE SEQUENCE IF NOT EXISTS unit_specifications_id_seq START 29;
    ALTER TABLE unit_specifications ALTER COLUMN id SET DEFAULT nextval('unit_specifications_id_seq');

    -- unit_types
    CREATE SEQUENCE IF NOT EXISTS unit_types_id_seq START 15;
    ALTER TABLE unit_types ALTER COLUMN id SET DEFAULT nextval('unit_types_id_seq');
...
ALTER TABLE financial_details
    ADD CONSTRAINT fk_financial_details_property FOREIGN KEY (property_id) REFERENCES properties (id) ON DELETE CASCADE;

ALTER TABLE investment_analysis
    ADD CONSTRAINT fk_investment_analysis_property FOREIGN KEY (property_id) REFERENCES properties (id) ON DELETE CASCADE;

ALTER TABLE legal_details
    ADD CONSTRAINT fk_legal_details_property FOREIGN KEY (property_id) REFERENCES properties (id) ON DELETE CASCADE;

ALTER TABLE market_analysis
    ADD CONSTRAINT fk_market_analysis_property FOREIGN KEY (property_id) REFERENCES properties (id) ON DELETE CASCADE;

ALTER TABLE properties
    ADD CONSTRAINT fk_properties_developer FOREIGN KEY (developer_id) REFERENCES developers (id),
    ADD CONSTRAINT fk_properties_location FOREIGN KEY (location_id) REFERENCES locations (id);

ALTER TABLE property_amenities
    ADD CONSTRAINT fk_property_amenities_property FOREIGN KEY (property_id) REFERENCES properties (id),
    ADD CONSTRAINT fk_property_amenities_amenity FOREIGN KEY (amenity_id) REFERENCES amenities (id);

ALTER TABLE property_challenges
    ADD CONSTRAINT fk_property_challenges_property FOREIGN KEY (property_id) REFERENCES properties (id),
    ADD CONSTRAINT fk_property_challenges_challenge FOREIGN KEY (challenge_id) REFERENCES challenges (id);

ALTER TABLE property_connectivity
    ADD CONSTRAINT fk_property_connectivity_property FOREIGN KEY (property_id) REFERENCES properties (id);

ALTER TABLE property_documents
    ADD CONSTRAINT fk_property_documents_property FOREIGN KEY (property_id) REFERENCES properties (id);

ALTER TABLE property_gallery
    ADD CONSTRAINT fk_property_gallery_property FOREIGN KEY (property_id) REFERENCES properties (id);

ALTER TABLE reviews
    ADD CONSTRAINT fk_reviews_property FOREIGN KEY (property_id) REFERENCES properties (id) ON DELETE CASCADE;

ALTER TABLE room_details
    ADD CONSTRAINT fk_room_details_unit_type FOREIGN KEY (unit_type_id) REFERENCES unit_types (id);

ALTER TABLE timeline
    ADD CONSTRAINT fk_timeline_property FOREIGN KEY (property_id) REFERENCES properties (id) ON DELETE CASCADE;

ALTER TABLE unit_specifications
    ADD CONSTRAINT fk_unit_specifications_unit_type FOREIGN KEY (unit_type_id) REFERENCES unit_types (id);

ALTER TABLE unit_types
    ADD CONSTRAINT fk_unit_types_property FOREIGN KEY (property_id) REFERENCES properties (id);
